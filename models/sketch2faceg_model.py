...
class Sketch2FaceGModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A', 'fake_B', 'fake_B_2', 'real_B', 'real_gray_B']
    ...
    def set_input(self, input):
        ...
        self.real_gray_B = input['gray'].to(self.device)
    ...
    def backward_G(self):
        ...
        # Second, G(A) = B
        self.loss_G_L1 = self.criterionL1(self.fake_B, self.real_gray_B) * self.opt.lambda_L1
        # Do iterative refinement: colorize
