...
Usage:
    calculate_eval_metrics_ir.py [options]
                 
Options:
    -h --help                               show this screen.
    --images_path=<string>                  path to images to compare                         
    --dataset=<string>                      one of `baseline`, `interrefinec` for color model, `iterrefineg` for grayscale model
    --mode=<string>                         either `final` or `intermediate` for output of generator 1 or 2
...
def main():
    ...
    image_path_pairs = make_image_path_pairs(images_path, dataset, mode)
